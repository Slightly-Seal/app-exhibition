...
public class Framework extends JFrame implements ActionListener {
	...
	public void mainMenu() {	
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				frame.setBounds(
						new Rectangle(
						 (int) mainFrame.getBounds().getX() + 50,
				            (int) mainFrame.getBounds().getY() + 50, 
				            (int) mainFrame.getBounds().getWidth(), 
	...
	public void createAccMenu() {
		...
		createAccFrame.getContentPane().add(createAccPanel);
	...
	public void createLogin() {
		...
		loginFrame.getContentPane().add(text_password);
		...
		loginFrame.getContentPane().add(button1);
		JPanel back = new JPanel();
		back.setLayout(new BorderLayout());
		back.add(backButton2, "South");
		loginFrame.getContentPane().add(back);
